...
# Phase 1 - Script 04d: 论文用同心圆图 (右侧图例排版版)
# -----------------------------------------------------------------------------
# 目标版式: 圆环主体左侧，折线 inset 在右上缺口，图例独立放右侧。
# 科学边界: 每个阶段固定 270 度；弧长不编码细胞总数，n 只作文字标注。
# =============================================================================
...
legend_grob <- cowplot::get_legend(pRing_base)
...
writeLines(capture.output(sessionInfo()), file.path(logs_dir, "04d_论文用同心圆图_sessionInfo.txt"))
